...
//Images
import faces17 from '../../assets/img/faces/17.jpg';
...
import faces16 from '../../assets/img/faces/16.jpg';
...
import usFlag from '../../assets/img/flags/us_flag.jpg';
import spainFlag from '../../assets/img/flags/spain_flag.jpg';
import germanyFlag from '../../assets/img/flags/germany_flag.jpg';
import russiaFlag from '../../assets/img/flags/russia_flag.jpg';
import italyFlag from '../../assets/img/flags/italy_flag.jpg';
import frenchFlag from '../../assets/img/flags/french_flag.jpg';
								...
								<Row className="">
									<Col>
										...
										<div className="h3 mt-2 mb-2"><b>{idx.data1}</b><span
											className="text-success tx-13 ms-2">{idx.data2}</span></div>
									</Col>
					...
					<Card className="order-list">
						<Card.Body>
							...
							<p className="tx-12 tx-gray-500 mb-3">Order Activity is ecommerce platforms to track the
								orders placed on their stores <Link to="#">Learn more</Link></p>
						...
						<Card.Body>
							<ul className="sales-session mb-0">
								<li>
									...
									<div className="progress  ht-5">
										<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
											className="progress-bar wd-60p bg-primary" role="progressbar"></div>
									</div>
								</li>
								<li>
									<div className="d-flex justify-content-between">
									...
									<div className="progress  ht-5">
										<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
											className="progress-bar wd-70p bg-info" role="progressbar"></div>
									</div>
								</li>
								<li>
									<div className="d-flex justify-content-between">
									...
									<div className="progress  ht-5">
										<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60"
											className="progress-bar wd-60p bg-danger" role="progressbar"></div>
									</div>
								</li>
								<li>
									<div className="d-flex justify-content-between">
									...
									<div className="progress  ht-5">
										<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
											className="progress-bar wd-50p bg-warning" role="progressbar"></div>
									</div>
								</li>
								<li>
									<div className="d-flex justify-content-between">
									...
									<div className="progress mb-0 ht-5">
										<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
											className="progress-bar wd-40p bg-success" role="progressbar"></div>
									</div>
								</li>
								<li className="mb-0 pb-1">
									...
									<div className="progress mb-0 ht-5">
										<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50"
											className="progress-bar wd-60p bg-purple" role="progressbar"></div>
									</div>
								</li>
							</ul>
						</Card.Body>
