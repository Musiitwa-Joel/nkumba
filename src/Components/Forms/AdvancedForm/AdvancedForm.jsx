...
const AdvancedForm = () => {
	...
	return (
		...
		<div className={styles.AdvancedForm}>
			<Pageheader titles="Forms" active="Form-Advanced" />
					...
					<Card>
						<Card.Body>
							...
							<div className="mb-4">
								...
								<Select closeMenuOnSelect={false} components={animatedComponents} defaultValue={2} isMulti options={MultiDropdown} classNamePrefix="Select" />
							</div>
							<div>
								<p className="mg-b-10">Multiple Select-2</p>
								<Creatable isMulti classNamePrefix="Select2" options={Groupeddata} value={Multi} onChange={setMulti} />
							</div>
						</Card.Body>
					</Card>
				</Col>
					...
					<Card>
						<Card.Body>
							...
							<div className="mb-4 d-lg-flex">
								...
								<Col sm={12} lg={4} className="mg-t-10 mg-md-t-0">
