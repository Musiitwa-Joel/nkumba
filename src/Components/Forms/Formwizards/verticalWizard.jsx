                ...
                <>
                    <Row className="" >
                        <Col xl={4} className="border-end">
                            <span className="Stepperh3 d-flex p-4"><span className="number step3 me-2 active">1</span><span className="title" onClick={() => setGoSteps(0)}>Personal Information</span></span>
                ...
                <div>
                    <Row className="" >
                        <Col xl={4} className=" border-end">
                            ...
                            <span className="Stepperh3 d-flex p-4"><span className="number step3 me-2 active">2</span><span className="title" onClick={() => setGoSteps(1)}>Billing Information </span></span>
                            <span className="Stepperh3 d-flex p-4"><span className="number step2 me-2">3</span><span className="title Step1" onClick={() => setGoSteps(2)}>Payment Details</span></span>
                        </Col>
                        <Col xl={8} className="p-4">
                            <section>
                ...
                <>
                    <Row className="">
                        <Col xl={4} className="border-end">
                            <span className="Stepperh3 d-flex p-4"><span className="number step2 me-2">1</span><span className="title Step1" onClick={() => setGoSteps(0)}>Personal Information</span></span>
                            <span className="Stepperh3 d-flex p-4"><span className="number step2 me-2">2</span><span className="title Step1" onClick={() => setGoSteps(1)}>Billing Information </span></span>
                            <span className="Stepperh3 d-flex p-4"><span className="number step3 me-2 active">3</span><span className="title" onClick={() => setGoSteps(2)}>Payment Details</span></span>
                        </Col>
                        <Col xl={8} className="p-4">
                            <section>
                                <Form.Group>
