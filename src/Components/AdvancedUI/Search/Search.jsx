					...
					<Tab.Content>
						<Tab.Pane eventKey={inputType}>
							<Card className="custom-card">
								<Card.Body>
									<div className="mb-2">
										<Card.Title href="#" className="h5">Search the new animations</Card.Title>
									</div>
							...
							<Card className="custom-card">
								<Card.Body>
									<div className="mb-2">
										<Card.Title href="#" className="h5">Free Boostrap admin templates</Card.Title>
									</div>
									<h6 className="tx-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
										dolore eu fugiat nulla pariatur eu fugiat nulla pariatur</h6>
									<p className="mb-0 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
							...
							<Card className="custom-card">
								<Card.Body>
									<div className="mb-2">
										<Card.Title href="#" className="h5">20+ download the free templates</Card.Title>
									</div>
									<h6 className="tx-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
										dolore eu fugiat nulla pariatur eu fugiat nulla pariatur</h6>
									<p className="mb-0 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
							...
							<Card className="custom-card">
								<Card.Body>
									<div className="mb-2">
										<Card.Title href="#" className="h5">Customizable admin templates</Card.Title>
									</div>
									<h6 className="tx-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
										dolore eu fugiat nulla pariatur eu fugiat nulla pariatur</h6>
									<p className="mb-0 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
							...
							<Card className="custom-card">
								<Card.Body>
									<div className="mb-2">
										<Card.Title href="#" className="h5">HTML Admin templates</Card.Title>
									</div>
									<h6 className="tx-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
										dolore eu fugiat nulla pariatur eu fugiat nulla pariatur</h6>
									<p className="mb-0 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
							...
							<Card className="custom-card">
								<Card.Body>
									<div className="mb-2">
										<Card.Title href="#" className="h5">Best free admin templates</Card.Title>
									</div>
									<h6 className="tx-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
										dolore eu fugiat nulla pariatur eu fugiat nulla pariatur</h6>
									<p className="mb-0 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
