						...
						<Card.Body>
							...
							<Modal show={Basic} backdrop="static" keyboard={false}>
								<Modal.Header >
									...
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("Basic") }}><i className='fe fe-x ms-auto'></i></Link>
								</Modal.Header>
								<Modal.Body>
									<h6>Modal Body</h6>
						...
						<Card.Body>
							...
							<Modal size="sm" show={show2} >
								<Modal.Header>
									...
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show2") }}><i className='fe fe-x ms-auto'></i></Link>
								</Modal.Header>
						...
						<Card.Body>
							...
							<Modal size="lg" show={show3}>
								<Modal.Header>
									...
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show3") }}><i className='fe fe-x ms-auto'></i></Link>
								</Modal.Header>
						...
						<Card.Body>
							...
							<Modal size="lg" show={show4}>
								<Modal.Header>
									...
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show4") }}><i className='fe fe-x ms-auto'></i></Link>
								</Modal.Header>
								<Modal.Body>
									<Row>
										<Col md={6}>
						...
						<Card.Body>
							...
							<Modal show={show5} backdrop="static" centered>
								<Modal.Body className="text-center p-4 pb-5" >
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show5") }}><i className='fe fe-x ms-auto'></i></Link>
					...
					<Card className="custom-card">
						<Card.Body>
							...
							<Modal show={show6} backdrop="static" centered>
								<Modal.Body className="text-center p-4 pb-5" >
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show6") }}><i className='fe fe-x ms-auto'></i></Link>
						...
						<Card.Body>
							...
							<Modal show={show7} >
								<Modal.Header>
									...
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show7") }}><i className='fe fe-x ms-auto'></i></Link>
								</Modal.Header>
								<Modal.Body>
									<h6>Modal Body</h6>
						...
						<div className="card-body">
							...
							<Modal show={show8} backdrop="static" keyboard={false}>
								<Modal.Header>
									...
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show8") }}><i className='fe fe-x ms-auto'></i></Link>
								</Modal.Header>
								<Modal.Body>
					...
					<Card className="custom-card">
						<Card.Body>
							...
							<Modal className='modal-dialog-scrollable' show={show9} backdrop="static">
								<Modal.Header>
									<Modal.Title>Scrolling With Content Modal</Modal.Title>
									<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose("show9") }}><i className='fe fe-x ms-auto'></i></Link>
								</Modal.Header>
								<Modal.Body>
									<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia
										consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>
								...
								<Col sm={6} md={4} xl={3} className="col-sm-6 col-md-4 col-xl-3">
									...
									<Rodal onClose={hide} visible={animation1} animation='Zoom' height={280} onClick={() => viewDemoClose1("Basic")} >
										<div className='modal-header'>Modal Header
											<Link to="#" as='span' className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("Basic") }}><i className='fe fe-x ms-auto'></i></Link>
										</div>
										<div className='modal-body'>
											<h6>Modal Body</h6>
