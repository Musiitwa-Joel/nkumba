...
import login from '../../assets/img/media/login.png';
                                                ...
                                                <div className="main-signup-header">
                                                    ...
                                                    <Form action="#">
                                                        ...
                                                        <Row className="row-xs">
                                                            <Col sm={6} className="">
                                                                <Button className="btn-block" onClick={logGoogleUser}><i className="fab fa-facebook-f"></i> Signup with Google</Button>
                                                            </Col>
                                                    ...
                                                    <div className="main-signin-footer mt-5">
                                                        ...
                                                        <p>Don't have an account? <Link to={`${import.meta.env.BASE_URL}admissionsignup`}>Create an Account</Link></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
