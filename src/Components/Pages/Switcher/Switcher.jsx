...
const Switcher = ({ SwitcherAction, changePrimaryColor, darkPrimaryColor, transparentPrimaryColor, transparentBackground, BGImagePrimaryColor }) => {
									...
									<div className="form_holder sidebar-right1">
										<Row className="row-sm">
											<div className="predefined_styles text-start">
												...
												<div className="swichermainleft">
													<h5 className="py-3 bd-y mb-0">Light Theme Style</h5>
													<div className="skin-body p-2 m-0">
														<div className="switch_section">
															<div className="switch-toggle d-flex">
															...
															<div className="switch-toggle d-flex">
																...
																<div className="">
																	<input className="wd-25 ht-25 input-color-picker color-primary-light" defaultValue="#0162e8" id="colorID" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id7="transparentcolor" name="lightPrimary" onChange={(ele) => { changePrimaryColor(ele.target.value) }} />
																</div>
															</div>
														</div>
													</div>
												...
												<div className="swichermainleft">
													<h5 className="py-3 bd-y mb-0">Dark Theme Style</h5>
													<div className="skin-body p-2 m-0">
														<div className="switch_section">
															<div className="switch-toggle d-flex mt-2">
															...
															<div className="switch-toggle d-flex mt-2">
																...
																<div className="">
																	<input className="wd-25 ht-25 input-dark-color-picker color-primary-dark" defaultValue="#0162e8" id="darkPrimaryColorID" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id3="primary" data-id8="transparentcolor" name="darkPrimary" onChange={(ele) => { darkPrimaryColor(ele.target.value) }} />
																</div>
															</div>
														</div>
													</div>
												...
												<div className="swichermainleft">
													<h5 className="py-3 bd-y mb-0">Transparent Style</h5>
													<div className="skin-body p-2 m-0">
														<div className="switch_section">
															<div className="switch-toggle d-flex mt-2 mb-3">
																<span className="me-auto">Transparent Theme</span>
																<p className="onoffswitch2 my-0"><input type="radio" name="onoffswitch1" id="myonoffswitchTransparent" onClick={() => { SwitcherAction('Transparent') }} className="onoffswitch2-checkbox" />
																	<label htmlFor="myonoffswitchTransparent"
																		className="onoffswitch2-label"></label>
																</p>
															</div>
															<div className="switch-toggle d-flex">
																...
																<div className="">
																	<input className="wd-30 ht-30 input-transparent-color-picker color-primary-transparent" defaultValue="#0162e8" id="transparentPrimaryColorID" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id3="primary" data-id4="primary" data-id9="transparentcolor" name="tranparentPrimary" onChange={(ele) => { transparentPrimaryColor(ele.target.value) }} />
																</div>
															</div>
															<div className="switch-toggle d-flex mt-2">
																<span className="me-auto">Transparent Background</span>
																<div className="">
																	<input className="wd-30 ht-30 input-transparent-color-picker color-bg-transparent" defaultValue="#0162e8" id="transparentBgColorID" type="color" data-id5="body" data-id6="theme" data-id9="transparentcolor" name="transparentBackground" onChange={(ele) => { transparentBackground(ele.target.value) }} />
																</div>
															</div>
														</div>
													</div>
												...
												<div className="swichermainleft">
													<h5 className="py-3 bd-y mb-0">Transparent Bg-Image Style</h5>
													<div className="skin-body p-2 m-0">
														<div className="switch_section">
															<div className="switch-toggle d-flex">
																<span className="me-auto">BG-Image Primary</span>
																<div className="">
																	<input className="wd-30 ht-30 input-transparent-color-picker color-primary-transparent" defaultValue="#0162e8" id="transparentBgImgPrimaryColorID" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id3="primary" data-id4="primary" data-id9="transparentcolor" name="tranparentPrimary" onChange={(ele) => { BGImagePrimaryColor(ele.target.value) }} />

																</div>
															</div>
															<div className="switch-toggle">
																<Link className="bg-img1" onClick={() => { SwitcherAction('BG-Image-1') }} to="#"><img src={bg1} id="bgimage1" alt="switch-img" /></Link>
																<Link className="bg-img2" onClick={() => { SwitcherAction('BG-Image-2') }} to="#"><img src={bg2} id="bgimage2" alt="switch-img" /></Link>
																<Link className="bg-img3" onClick={() => { SwitcherAction('BG-Image-3') }} to="#"><img src={bg3} id="bgimage3" alt="switch-img" /></Link>
																<Link className="bg-img4" onClick={() => { SwitcherAction('BG-Image-4') }} to="#"><img src={bg4} id="bgimage4" alt="switch-img" /></Link>
															</div>
														</div>
													</div>
												</div>
