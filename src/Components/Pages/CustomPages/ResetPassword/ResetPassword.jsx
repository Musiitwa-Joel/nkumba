...
import Reset from '../../../../assets/img/media/reset.png';
	...
	return (
		...
		<div className={styles.ResetPassword}>
			<div className="d-flex">
				<Link className="demo-icon new nav-link" to="#" > <svg xmlns="http://www.w3.org/2000/svg" className="header-icon-svgs fa-spin" width="24" height="24" viewBox="0 0 24 24">
												...
												<div className="main-signin-header">
													<div className="">
														...
														<Form>
															...
															<Button className="ripple btn-main-primary btn-block">Reset Password</Button>
														</Form>
													</div>
												</div>
