							...
							<Card className="mg-b-20">
								...
								<Collapse in={expanded}>
									<div>
										...
										<Form.Control className='me-3' type="text" placeholder="User Name" />
										<Form.Control as='textarea' type="text" className='me-3' placeholder="New Assign Task Description" />
