...
export const pricingCards = [
    { id: 1, cardname: 'Airtel Money', data: 'UGX 100,000', name1: '2', name2: '3', name3: '1',  },
    { id: 2, cardname: 'MTN Mob Money', data: 'UGX 100,000', name1: '3', name2: '4', name3: '2', color: 'warning' },
    { id: 3, cardname: 'Bank', data: 'UGX 100,000', name1: '5', name2: '8', name3: '2', color: 'success' },
    { id: 4, cardname: 'Other', data: 'UGX 100,000', name1: '4', name2: '6', name3: '2', color: 'danger' },
]