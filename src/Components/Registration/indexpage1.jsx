...
import {} from "../CommonFileComponents/LightGallery";
import airtelLogo from "../../../src/assets/payment/bharti-airtel-limited.svg";
import mtnLogo from "../../../src/assets/payment/mtn-new-logo.svg";
import bankLogo from "../../../src/assets/payment/banks.png";
            ...
            <Card>
              ...
              <Card.Body className="p-0">
                <Nav variant="pills" className="flex-column tab_list">
                  ...
                  <Nav.Item className="flex-grow-1">
                    <Nav.Link eventKey="fifteen" className="w-100">
                      <span
                        style={{ fontWeight: "bold", fontFamily: "poppins" }}
                      >
                        <i className="fa fa-graduation-cap me-2"></i>
                    ...
                    <Tab.Pane eventKey="sixteen">
                      ...
                      <Row>
                        <Col md={12}>
                          ...
                          >
                            Reasearch And Professional Experience
                          </Card.Title>
                          <Card.Body
                            style={{
                              marginLeft: -23,
                        ...
                        <Col md={12}>
                          ...
                          >
                            Publications/ Exhibitions/ Folio/ (Provide relevant
                            information)
                          </Card.Title>
                          <Card.Body
                            style={{
                        ...
                        <Col lg={12} xl={12}>
                          <Row xl={8} lg={8}>
                            <Col xs={12} sm={12} lg={4} xl={4}>
                              <div
                                className="panel price panel-color example"
                                style={{
                                  padding: 0,
                                }}
                              >
                                <div
                                  className={`panel-heading bg-${"primary"} p-0 text-center`}
                                >
                                  <h3 style={{ backgroundColor: "#e50002" }}>
                                    {"AIRTEL MONEY"}
                                  </h3>
                                </div>
                                <div className="panel-body text-center">
                                  <p className="lead">
                                    <strong>{"UGX 50000"}</strong>
                                  </p>
                                </div>
                                <ListGroup
                                  style={{
                            ...
                            <Col xs={12} sm={12} lg={4} xl={4}>
                              ...
                              >
                                <div
                                  className={`panel-heading bg-${"primary"} p-0 text-center`}
                                >
                                  <h3 style={{ backgroundColor: "#ffc402" }}>
                                    {"MTN Mob Money"}
                                  </h3>
                                </div>
                                <div className="panel-body text-center">
