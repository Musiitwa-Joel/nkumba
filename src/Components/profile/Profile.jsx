...
import { Button, Card, Col, Dropdown, Form, Nav, ProgressBar, Row, Tab, Table } from 'react-bootstrap';
              ...
              <div className="ps-0">
                <div className="main-profile-overview">
                  <div className="main-img-user profile-user">
                    <img alt="" src="http://199.241.139.118:9000/api/lecturer/image/NUL279" />
                    <Link className="fas fa-camera profile-edit" to="#"></Link>
                  </div>
                  <div className="d-flex justify-content-between mg-b-20">
                    <div>
                      <h5 className="main-profile-name">Male Vicent</h5>
                      ...
                      <p className="main-profile-name-text">NUL456</p>
                    </div>
                  </div>
                  {/* <h6>Bio</h6>
                  ...
                  <Row>
                    <Col md={4} className="col mb20">
                      <h5>51</h5>
                      <h6 className="text-small text-muted mb-0">Enrolled</h6>
                    </Col>
                    <Col md={4} className="col mb20">
                      <h5>34</h5>
                      <h6 className="text-small text-muted mb-0">Attended</h6>
                    </Col>
                    <Col md={4} className="col mb20">
                      <h5>12</h5>
                      <h6 className="text-small text-muted mb-0">Absent</h6>
                    </Col>
                  </Row>
                  ...
                  <div md={0} className="">
                    ...
                    >
                      <div>
                        <h6 className="main-profile-name">Room: </h6>
                      </div>

                      <div>
                        <span className="main-profile-name">SK2</span>
                      </div>
                    </div>
                    <hr className="mg-y-20" />
                    <div
                    ...
                    >
                      <div>
                        <h6 className="main-profile-name">Status: </h6>
                      </div>

                      <div>
                        <span className="main-profile-name">Ongoing</span>
                      </div>
                    </div>
                    <hr className="mg-y-20" />
                    <div
                    ...
                    >
                      <div>
                        <h6 className="main-profile-name">Class Rep: </h6>
                      </div>

                      <div>
                        <span className="main-profile-name">Musiitwa Joel</span>
                      </div>
                    </div>
                    <hr className="mg-y-20" />
                    <div
                    ...
                    >
                      <div>
                        <h6 className="main-profile-name">Started at: </h6>
                      </div>

                      <div>
                        <span className="main-profile-name">7:00 AM</span>
                      </div>
                    </div>
                    <hr className="mg-y-20" />
                    <div
                    ...
                    >
                      <div>
                        <h6 className="main-profile-name">Ended at: </h6>
                      </div>

                      <div>
                        <span className="main-profile-name">10:00 AM</span>
                      </div>
                    </div>
                    <hr className="mg-y-20" />
                    <div
                    ...
                    >
                      <div>
                        <h6 className="main-profile-name">Duration</h6>
                      </div>

                      <div>
                        <span className="main-profile-name">3 HRS</span>
                      </div>
                    </div>
                    <hr className="mg-y-20" />
                    <div
                    ...
                    >
                      <div>
                        <h6 className="main-profile-name">Lecture Mode: </h6>
                      </div>

                      <div>
                        <span className="main-profile-name">Physical</span>
                      </div>
                    </div>
                  </div>
                            ...
                            <Card.Body className="user-lock text-center">
                              ...
                              >
                                <img
                                  ...
                                  src={idx.image}
                                />
                                <h5 className="fs-16 mb-0 mt-3 text-dark fw-semibold">
                                  {idx.username}
                                </h5>
