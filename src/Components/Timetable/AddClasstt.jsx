...
const Tabs = () => {
  ...
  const handleDeleteClick = () => {
    // logic to delete the rendered component goes here
  };
                ...
                <div className="example">
                  <div className="panel panel-primary tabs-style-3">
                    ...
                    <Row style={{ marginBottom: 0 }}>
                      ...
                      <Col xl={6} className="mb-3">
                        <Form.Label>Select Studytime</Form.Label>
                        <Select
                          classNamePrefix="Select"
                          options={yearValue}
                          placeholder="Choose studytime"
                        />
                        <Form.Control.Feedback type="invalid">
                          {" "}
                          {/* Please provide a valid state. */}
...
<div>
                    ...
                    <Row>
                    <Col xl={6} className="mb-3">
                        <Form.Label>Select Course Unit</Form.Label>
                        <Select
                          classNamePrefix="Select"
                          options={studyYrValue}
                          placeholder="Select..."
...
<div className="btn-icon-list btn-list">
  <span style={{justifyContent: 'center', marginTop: '25px'}}>
  <Button variant='primary' className="" >
		<i className="fe fe-save me-2"></i>Save Timetable</Button>
  </span>
