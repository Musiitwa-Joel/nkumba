...
import worddoc from "../../../../assets/img/files/word.png";
						...
						<Card.Body className="main-content-left main-content-left-mail">
							...
							<div className="main-mail-menu">
								<Nav className="main-nav-column">
									<Nav.Link className="thumb active" to="#"><i className="fe fe-image"></i> Images </Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-music"></i> Music</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-video"></i> Videos</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-smartphone"></i> APKS</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-download"></i> Downloads</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-heart"></i> Favourites</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-eye"></i> Hidden FIles</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-share"></i> Transfer files </Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-database"></i> Google Drive</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-airplay"></i> FTP</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-lock"></i> Private FIles</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-wind"></i> Deep Clean</Nav.Link>
									<Nav.Link className="thumb" to="#"><i className="fe fe-grid "></i> More</Nav.Link>
								</Nav>
							</div>
							{/* <!-- main-mail-menu --> */}
