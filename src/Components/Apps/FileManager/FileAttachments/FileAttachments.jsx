                            ...
                            <div className="text-wrap pb-3">
                                <div className="file-image-1">
                                    <div className="product-image">
                                        ...
                                        <ul className="icons">
                                            <li><Link to="#" className="bg-danger"><i className="fe fe-trash"></i></ Link></li>
                                            <li><Link to="#" className="bg-pink"><i className="fe fe-download"></i></ Link></li>
                                            <li><Link to="#" className="bg-primary"><i className="fe fe-eye"></i></ Link></li>
                                        </ul>
                                    </div>
