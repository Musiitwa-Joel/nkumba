				...
				<Col md={12}>
					...
					{/* <Card className="mg-b-20">
						<Card.Body>
							...
							<div className="example border-0 p-0">
								<div className="btn-list">
									<Button variant='primary' className="mg-t-5 me-1">Mutiple lines</Button>
									<Button variant='primary' className="mg-t-5 me-1">Fade Animation</Button>
									<Button variant='primary' className="mg-t-5 me-1">Customize Background</Button>
									<Button variant='primary' className="mg-t-5 me-1">Timeout</Button>
								</div>
							</div>
						</Card.Body>
					</Card> */}
					...
					{/* <Card>
						<Card.Body>
							...
							<div className="example border-0 p-0">
								<div className="btn-list">
									<Button variant='primary' className="me-1">Call Back</Button>
									<Button variant='primary' className="me-1">Call Back 2</Button>
								</div>
							</div>
						</Card.Body>
					</Card> */}
