  ...
  return (
    <div className={styles.Cards}>
        ...
        <Col lg={12} xl={4} className="col-12">
          <Card>
            <Card.Body>
              ...
              <Card.Link to="#" className="text-muted">Card link</Card.Link>
              <Card.Link to="#" className="text-muted">Another link</Card.Link>
            </Card.Body>
          </Card>
        </Col>
        <Col lg={12} xl={4} className="col-12">
        ...
        <Col lg={12} xl={4} className="col-12">
          <Card className="bg-info">
            <Card.Body>
              ...
              <Card.Text as='p'>Ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</Card.Text>
              <Card.Link to="#" className="text-white">Card link</Card.Link>
              <Card.Link to="#" className="text-white">Another link</Card.Link>
            </Card.Body>
          </Card>
        </Col>
      </Row>
      ...
      <Row className="row-sm">
        ...
        <Row className="row-sm">
          <div className="col-md">
            <Card.Body className="tx-white-8 bg-primary bd-0">
          ...
          <div className="col-md  mg-md-t-0">
            <Card.Body className="tx-white-8 bg-secondary bd-0">
              Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet consictetur.
            </Card.Body>
          </div>
          <div className="col-md mg-md-t-0">
