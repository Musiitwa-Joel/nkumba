			...
			<Row>
				...
				<Col lg={6}>
					<Card>
						...
						<Card.Body className="pt-0">
							<ListGroup>
								<ListGroup.Item href="#" className="list-group-item-action" active>The current link item</ListGroup.Item>
								<ListGroup.Item href="#" className="list-group-item-action">A second link item</ListGroup.Item>
								<ListGroup.Item href="#" className="list-group-item-action">A third link item</ListGroup.Item>
								<ListGroup.Item href="#" className="list-group-item-action">A fourth link item</ListGroup.Item>
								<ListGroup.Item href="#" className="list-group-item-action" disabled>A disabled link item</ListGroup.Item>
							</ListGroup>
						</Card.Body>
					</Card>
				</Col>
