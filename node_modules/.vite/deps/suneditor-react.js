...
// node_modules/suneditor-react/dist/misc/getLanguage.js
var require_getLanguage = __commonJS({
  "node_modules/suneditor-react/dist/misc/getLanguage.js"(exports) {
    "use strict";
  ...
  "node_modules/suneditor/src/plugins/dialog/image.js"() {
    ...
    image_default = {
      ...
      update_image: function(init, openController, notHistoryPush) {
        ...
        if (isNewContainer) {
          let existElement = this.util.isRangeFormatElement(contextImage._element.parentNode) || this.util.isWysiwygDiv(contextImage._element.parentNode) ? contextImage._element : /^A$/i.test(contextImage._element.parentNode.nodeName) ? contextImage._element.parentNode : this.util.getFormatElement(contextImage._element) || contextImage._element;
...
function core_default(context, pluginCallButtons, plugins, lang, options, _responsiveButtons) {
  ...
  const core = {
    ...
    _createDefaultRange: function() {
      ...
      if (!focusEl) {
        focusEl = util2.createElement(options.defaultTag);
    ...
    appendFormatTag: function(element, formatNode) {
      ...
      if (!util2.isFormatElement(element) && util2.isFreeFormatElement(currentFormatEl || element.parentNode)) {
        ...
        if (formatNode && typeof formatNode !== "string" || !formatNode && util2.isFormatElement(currentFormatEl)) {
          util2.copyTagAttributes(oFormat, formatNode || currentFormatEl);
        }
      }
    ...
    detachRangeFormatElement: function(rangeElement, selectedFormats, newRangeElement, remove, notHistoryPush) {
      ...
      if (rangeElement.children.length === 0 || rangeElement.textContent.length === 0) {
        ...
        util2.removeEmptyNode(rangeElement, null);
      }
      let edge = null;
      if (remove) {
        edge = {
    ...
    _nodeChange_oneLine: function(element, newInnerNode, validation, startCon, startOff, endCon, endOff, isRemoveFormat, isRemoveNode, collapsed, _removeCheck, _getMaintainedNode, _isMaintainedNode) {
      ...
      util2.removeEmptyNode(pNode, newInnerNode);
      if (collapsed) {
    ...
    _nodeChange_endLine: function(element, newInnerNode, validation, endCon, endOff, isRemoveFormat, isRemoveNode, _removeCheck, _getMaintainedNode, _isMaintainedNode) {
      ...
      if (!isRemoveFormat && pNode.childNodes.length === 0) {
        ...
        if (!isRemoveNode && newInnerNode.textContent.length === 0) {
          util2.removeEmptyNode(pNode, null);
          return {
            ancestor: null,
            container: null,
            offset: 0
    ...
    setContents: function(html) {
      this.removeRange();
      const convertValue = html === null || html === void 0 ? "" : this.convertContentsForEditor(html);
    ...
    getContents: function(onlyContents) {
      ...
      const figcaptions = util2.getListChildren(renderHTML, function(current) {
    ...
    _makeLine: function(node, requireFormat) {
      ...
      if (node.nodeType === 1) {
        if (util2._disallowedTags(node))
          return "";
        const ch = util2.getListChildNodes(node, function(current) {
          return util2.isSpanWithoutAttr(current);
        }) || [];
    ...
    _cleanStyle: function(m, v, name2) {
      ...
      if (sv) {
        if (!v)
          v = [];
        const style = sv[0].replace(/&quot;/g, "").match(this._cleanStyleRegExp[name2]);
        if (style) {
          const allowedStyle = [];
    ...
    _cleanTags: function(lowLevelCheck, m, t) {
      ...
      if (tagName === "img") {
        ...
        if (sv) {
          w = sv[0].match(/width:(.+);/);
          w = util2.getNumber(w ? w[1] : "", -1) || "";
          h = sv[0].match(/height:(.+);/);
          h = util2.getNumber(h ? h[1] : "", -1) || "";
        }
        if (!w || !h) {
          const avw = m.match(/width\s*=\s*((?:"|')[^"']*(?:"|'))/);
          const avh = m.match(/height\s*=\s*((?:"|')[^"']*(?:"|'))/);
          if (avw || avh) {
            w = !w ? util2.getNumber(avw ? avw[1] : "") || "" : w;
            h = !h ? util2.getNumber(avh ? avh[1] : "") || "" : h;
          }
        }
      ...
      if (v) {
        for (let i = 0, len = v.length; i < len; i++) {
          if (lowLevelCheck && /^class="(?!(__se__|se-|katex))/.test(v[i].trim()))
            continue;
    ...
    _editFormat: function(dom) {
      ...
      for (let i = 0, len = tempTree.length, n; i < len; i++) {
        n = tempTree[i];
        if (!util2.isFormatElement(n) && !util2.isRangeFormatElement(n) && !util2.isComponent(n) && !/meta/i.test(n.nodeName)) {
          if (!f)
    ...
    _isFormatData: function(domTree) {
      ...
      for (let i = 0, len = domTree.length, t; i < len; i++) {
        t = domTree[i];
        if (t.nodeType === 1 && !util2.isTextStyleElement(t) && !util2.isBreak(t) && !util2._disallowedTags(t)) {
          requireFormat = true;
          break;
        }
      }
    ...
    cleanHTML: function(html, whitelist, blacklist) {
      ...
      try {
        util2._consistencyCheckOfHTML(dom, this._htmlCheckWhitelistRegExp, this._htmlCheckBlacklistRegExp, true);
      } catch (error) {
    ...
    convertContentsForEditor: function(contents) {
      ...
      try {
        util2._consistencyCheckOfHTML(dom, this._htmlCheckWhitelistRegExp, this._htmlCheckBlacklistRegExp, false);
      } catch (error) {
      ...
      for (let i = 0, t; i < domTree.length; i++) {
        t = domTree[i];
        if (!util2.isFormatElement(t) && !util2.isRangeFormatElement(t) && !util2.isComponent(t) && !util2.isMedia(t) && t.nodeType !== 8) {
          if (!p)
  ...
  const event = {
    ...
    onClick_wysiwyg: function(e) {
      ...
      if (figcaption && (util2.isNonEditable(figcaption) || !figcaption.getAttribute("contenteditable"))) {
        e.preventDefault();
    ...
    onKeyDown_wysiwyg: function(e) {
      ...
      switch (keyCode) {
        case 8:
          ...
          if (formatEl && range.startContainer === range.endContainer && selectionNode.nodeType === 3 && !util2.isFormatElement(selectionNode.parentNode)) {
            if (range.collapsed ? selectionNode.textContent.length === 1 : range.endOffset - range.startOffset === selectionNode.textContent.length) {
              ...
              util2.removeItemAllParents(selectionNode, null, formatEl);
          ...
          if (!selectRange && formatEl && (range.startOffset === 0 || (selectionNode === formatEl ? !!formatEl.childNodes[range.startOffset] : false))) {
            ...
            if (!sel.previousSibling && (util2.isComponent(commonCon.previousSibling) || ignoreZWS && util2.isComponent(prev))) {
            ...
            if (util2.isNonEditable(sel.previousSibling)) {
              e.preventDefault();
              e.stopPropagation();
        ...
        case 13:
          ...
          if (!shift) {
            ...
            if (formatInners && /^H[1-6]$/i.test(formatEl.nodeName) || /^HR$/i.test(formatEl.nodeName)) {
              ...
              break;
            } else if (options.lineAttrReset && formatEl && !util2.isListCell(formatEl)) {
              e.preventDefault();
              e.stopPropagation();
              let newEl;
              if (!range.collapsed) {
                ...
                if (isMultiLine) {
                  ...
                  newEl = util2.splitElement(r2.container, r2.offset, 0);
                }
              } else {
                if (util2.onlyZeroWidthSpace(formatEl))
                  newEl = core.appendFormatTag(formatEl, formatEl.cloneNode(false));
                else
                  newEl = util2.splitElement(range.endContainer, range.endOffset, 0);
              }
          ...
          if (rangeEl && formatEl && !util2.isCell(rangeEl) && !/^FIGCAPTION$/i.test(rangeEl.nodeName)) {
            ...
            if ((range2.commonAncestorContainer.nodeType === 3 ? !range2.commonAncestorContainer.nextElementSibling : true) && util2.onlyZeroWidthSpace(formatEl.innerText.trim())) {
              e.preventDefault();
              let newEl = null;
    ...
    onKeyUp_wysiwyg: function(e) {
      ...
      const alt = e.altKey;
      if (core.isReadOnly) {
        if (!ctrl && event._directionKeyCode.test(keyCode))
          event._applyTagEffects();
        return;
      }
      const range = core.getRange();
...
// node_modules/suneditor-react/dist/SunEditor.js
var require_SunEditor = __commonJS({
  "node_modules/suneditor-react/dist/SunEditor.js"(exports) {
    "use strict";
    ...
    var SunEditor = function(props) {
      ...
      (0, react_1.useEffect)(function() {
        ...
        if (onSave)
          editor.current.onSave = function(content) {
            return onSave(content);
          };
        if (onSetToolbarButtons)
          editor.current.onSetToolbarButtons = function(buttonList) {
            return onSetToolbarButtons(buttonList);
          };
        if (onResizeEditor)
          editor.current.onResizeEditor = function(height2, prevHeight) {
            return onResizeEditor(height2, prevHeight);
          };
        ...
        singleEvents.forEach(function(event) {
          var value = props[event];
          if (editor.current && event && value)
            editor.current[event] = function(e) {
              return value(e);
            };
        });
        ...
        if (showController && typeof showController === "function")
          editor.current.showController = function(name3, controllers) {
            return showController(name3, controllers);
          };
        return function() {
          if (editor.current)
      ...
      (0, react_1.useEffect)(function() {
        var _a2, _b2;
        if (!initialEffect.current) {
          if (setContents !== void 0)
            !((_a2 = editor.current) === null || _a2 === void 0 ? void 0 : _a2.core.hasFocus) && ((_b2 = editor.current) === null || _b2 === void 0 ? void 0 : _b2.setContents(setContents));
        }
      }, [setContents]);
      (0, react_1.useEffect)(function() {
        var _a2, _b2;
        if (!initialEffect.current) {
          if (appendContents !== void 0)
            (_a2 = editor.current) === null || _a2 === void 0 ? void 0 : _a2.appendContents(appendContents);
          (_b2 = editor.current) === null || _b2 === void 0 ? void 0 : _b2.core.focusEdge(null);
        }
      }, [appendContents]);
      (0, react_1.useEffect)(function() {
        var _a2, _b2, _c2, _d2, _e2, _f2, _g2, _h2, _j, _k;
        if (!initialEffect.current) {
          if (hideToolbar === true)
            (_a2 = editor.current) === null || _a2 === void 0 ? void 0 : _a2.toolbar.hide();
          else
            (_b2 = editor.current) === null || _b2 === void 0 ? void 0 : _b2.toolbar.show();
          if (disableToolbar === true)
            (_c2 = editor.current) === null || _c2 === void 0 ? void 0 : _c2.toolbar.disable();
          else
            (_d2 = editor.current) === null || _d2 === void 0 ? void 0 : _d2.toolbar.enable();
          if (disable === true)
            (_e2 = editor.current) === null || _e2 === void 0 ? void 0 : _e2.disable();
          else
            (_f2 = editor.current) === null || _f2 === void 0 ? void 0 : _f2.enable();
          if (readOnly === true)
            (_g2 = editor.current) === null || _g2 === void 0 ? void 0 : _g2.readOnly(true);
          else
            (_h2 = editor.current) === null || _h2 === void 0 ? void 0 : _h2.readOnly(false);
          if (hide === true)
...
// node_modules/suneditor-react/dist/misc/buttonList.js
var require_buttonList = __commonJS({
  "node_modules/suneditor-react/dist/misc/buttonList.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
